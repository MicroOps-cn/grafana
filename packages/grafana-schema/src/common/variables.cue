...
VariableFormatID:
    ...
    "queryparam" |
    // JSON Without Quote
    "jsonwithoutquote" @cuetsy(kind="enum",memberNames="Lucene|Raw|Regex|Pipe|Distributed|CSV|HTML|JSON|PercentEncode|UriEncode|SingleQuote|DoubleQuote|SQLString|Date|Glob|Text|QueryParam|JSONWithoutQuote")
